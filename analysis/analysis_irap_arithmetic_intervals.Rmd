...
p_ci_width_proportion_observed_range <-
  ...
  geom_linerange(aes(ymin = ci_lower, ymax = ci_upper), size = 1.25, position = position_dodge(width = 0.8)) +
  geom_point(position = position_dodge(width = 0.8), size = 2.5) +
  scale_shape_discrete(labels = c("*D* scores bootstrapped CIs", "*D* scores SEM CIs")) +
...
ggsave(filename  = "plots/supplementary_figure_8S_ci_widths_irap_d_boot_vs_sem.pdf",
       plot      = p_ci_widths,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
...
## Supplementary Figure 9S 

```{r fig.height=7, fig.width=8}

p_diff_zero

ggsave(filename  = "plots/supplementary_figure_9_proportion_excluding_zero_point_irap_boot_vs_sem.pdf",
       plot      = p_diff_zero,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
...
## Supplementary Figure 10S 

```{r fig.height=7, fig.width=8}

p_discriminability

ggsave(filename  = "plots/supplementary_figure_10_proportion_discriminable_irap_boot_vs_sem.pdf",
...
## Supplementary Figure 11S 

```{r}

p_coverage

ggsave(filename  = "plots/supplementary_figure_11_proportion_coverage_irap_boot_vs_sem.pdf",
       plot      = p_coverage,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
...
ggsave(filename  = "plots/supplementary_figure_12_metaanalyses_irap_d_boot_vs_sem.pdf",
       plot      = p_combined,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
