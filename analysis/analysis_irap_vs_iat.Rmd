...
ggsave(filename  = "plots/supplementary_figure_2_cis_by_domain_iat_d.pdf",
...
ggsave(filename  = "plots/supplementary_figure_ci_widths_iat_d.pdf",
       plot      = p_ci_widths,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
...
ggsave(filename  = "plots/supplementary_figure_proportion_excluding_zero_point_iat.pdf",
       plot      = p_diff_zero,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
...
ggsave(filename  = "plots/figure_3_metaanalyses_irap_d_vs_iat_d.pdf",
       plot      = p_combined,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
