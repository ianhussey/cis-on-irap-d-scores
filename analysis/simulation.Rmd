...
# simulated_data_18_include <- simulated_data_18_temp %>%
#   group_by(id) %>%
#   summarize(min = min(simulated_value, na.rm = TRUE),
#             .groups = "drop") %>%
#   filter(min > 750) 
# 
# simulated_data_18 <- simulated_data_18_temp %>%
#   semi_join(simulated_data_18_include, by = "id")
...
simulated_data_180_exclude <- simulated_data_180_temp %>%
  filter(simulated_value < 0) 

simulated_data_180 <- simulated_data_180_temp %>%
  anti_join(simulated_data_180_include, by = "id")
...
ggplot(simulated_data_180_temp, aes(simulated_value, color = block_type)) +
  geom_density() +
