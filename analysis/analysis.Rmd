...
if(file.exists("../data/processed/data_estimates_D.rds")) {
  
  data_estimates_D <- read_rds("../data/processed/data_estimates_D.rds")
  ...
  # save to disk
  write_rds(data_estimates_D, "../data/processed/data_estimates_D.rds", compress = "gz")
...
# bootstrapping has a long execution time, so load saved values if they've already been calculated
if(file.exists("../data/processed/data_estimates_PI.rds")) {
  
  data_estimates_PI <- read_rds("../data/processed/data_estimates_PI.rds")
  ...
  # save to disk
  write_rds(data_estimates_PI, "../data/processed/data_estimates_PI.rds", compress = "gz")
...
if(file.exists("../data/results/data_discriminability_D.csv")) {
  ...
  data_discriminability_D <- read_rds("../data/results/data_discriminability_D.csv")
...
if(file.exists("../data/results/data_discriminability_PI.csv")) {
  ...
  data_discriminability_PI <- read_rds("../data/results/data_discriminability_PI.csv")
