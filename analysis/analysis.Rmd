...
p_ci_width_proportions_method <- 
  ...
  geom_line(position = position_dodge(width = dodge_width)) +
  geom_point(position = position_dodge(width = dodge_width), size = 2.5) +
  # scale_shape_discrete(labels = c("BCA", "Basic", "Normal", "Percentile", "Arithmethic")) +
  # scale_color_viridis_d(end = 0.8, labels = c("BCA", "Basic", "Normal", "Percentile", "Arithmethic")) +
  mdthemes::md_theme_linedraw() +
  scale_x_discrete(labels = c("tt1" = "1", "tt2" = "2", "tt3" = "3", "tt4" = "4")) +
  labs(x = "Trial type",
       y = "95% CI width / observed range",
...
# tests
emmeans(p_ci_width_proportions_method, list(pairwise ~ DV_type | trial_type), adjust = "bonferroni")
emmeans(p_ci_width_proportions_method, list(pairwise ~ trial_type | DV_type), adjust = "bonferroni")
