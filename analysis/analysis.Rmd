...
if(file.exists("models/data_D_estimates_with_CIs.rds")) {
  ...
  # save to disk
  write_rds(data_estimates_D, path = "models/data_estimates_D.rds")
...
# bootstrapping has a long execution time, so load saved values if they've already been calculated
if(file.exists("models/data_PI_estimates_with_CIs.rds")) {
  ...
  # save to disk
  write_rds(data_estimates_PI, path = "models/data_estimates_PI.rds")
