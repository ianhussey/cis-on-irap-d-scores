...
fit_ci_width_proportions <- 
  lmer(ci_width_proportion ~ trial_type * method * DV_type + (1 | domain/unique_id),
       data = data_ci_width_proportions_combined)


# results table
tab_model(fit_ci_width_proportions, 
          string.p = "p (corrected)", 
          ci.hyphen = ", ",
          #emph.p = FALSE,
          p.adjust = "holm")
...
results_emm_ci_width_proportions <- 
  summary(emmeans(fit_ci_width_proportions, ~ DV_type | trial_type + method)) %>%
