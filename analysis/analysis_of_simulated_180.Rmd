...
subtitle: "Simulated 180 trials per *D* score"
author: "Ian Hussey"
...
data_trial_level <- read_rds("../data/data_trial_level_simulated_180_trials.rds") %>%
...
data_outliers <- data_trial_level %>%
  ...
  full_join(data_trial_level, by = c("unique_id", "domain")) %>%
...
if(file.exists("models/simulated_estimates_D_180_trials.rds")) {
  ...
  data_estimates_D <- read_rds("models/simulated_estimates_D_180_trials.rds")
  ...
  # save to disk
  write_rds(data_estimates_D, "models/simulated_estimates_D_180_trials.rds", compress = "gz")
...
# bootstrapping has a long execution time, so load saved values if they've already been calculated
if(file.exists("models/simulated_estimates_PI_180_trials.rds")) {
  
  data_estimates_PI <- read_rds("models/simulated_estimates_PI_180_trials.rds")
  ...
  # save to disk
  write_rds(data_estimates_PI, "models/simulated_estimates_PI_180_trials.rds", compress = "gz")
...
# save to disk
write_rds(data_ci_width_map_D, "models/simulated_ci_width_map_D_180_trials.rds")
...
# save to disk
write_rds(data_diff_zero, "models/simulated_diff_zero_180_trials.rds")
...
# save to disk
write_rds(results_diff_zero_scoring, "models/results_diff_zero_scoring_180_trials.rds")
...
# bootstrapping has a long execution time, so load saved values if they've already been calculated
if(file.exists("models/simulated_discriminability_D_180_trials.rds")) {
  
  data_discriminability_D <- read_rds("models/simulated_discriminability_D_180_trials.rds")
  ...
  # save to disk
  write_rds(data_discriminability_D, "models/simulated_discriminability_D_180_trials.rds", compress = "gz")
...
# bootstrapping has a long execution time, so load saved values if they've already been calculated
if(file.exists("models/simulated_discriminability_PI_180_trials.rds")) {
  
  data_discriminability_PI <- read_rds("models/simulated_discriminability_PI_180_trials.rds")
  ...
  # save to disk
  write_rds(data_discriminability_PI, "models/simulated_discriminability_PI_180_trials.rds", compress = "gz")
...
# save to disk
write_rds(results_disciminability_scoring, "models/results_disciminability_scoring_180_trials.rds")
...
# save to disk
write_rds(results_disciminability_method, "models/results_disciminability_method_180_trials.rds")
...
# save to disk
write_rds(results_ci_width_proportions_scoring, "models/results_ci_width_proportions_scoring_180_trials.rds")
...
# fit model
if(file.exists("models/fit_ci_width_proportions_method_180_trials.rds")) {
  
  fit_ci_width_proportions_method <- read_rds("models/fit_ci_width_proportions_method_180_trials.rds")
  ...
  write_rds(fit_ci_width_proportions_method, "models/fit_ci_width_proportions_method_180_trials.rds")
...
# save to disk
write_rds(results_ci_width_proportions_method, "models/results_ci_width_proportions_method_180_trials.rds")
...
ggsave(filename  = "plots/figure_1_cis_by_domain_simulated_180_trials.pdf",
...
ggsave(filename  = "plots/figure_2_ci_widths_simulated_180_trials.pdf",
       plot      = p_ci_widths,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
...
ggsave(filename  = "plots/figure_3_metaanalyses_simulated_180_trials.pdf",
       plot      = p_combined,
       device    = "pdf",
       # path      = NULL,
       # dpi       = 300,
