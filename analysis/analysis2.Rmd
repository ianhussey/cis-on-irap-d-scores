...
- look up metafor package on combining taus in three level models, check against here
...
p_prop_nonzero_scoring <- 
  ggplot(results_diff_zero_scoring, aes(DV_type, estimate, 
                                        #color = DV_type, 
                                        #shape = DV_type, 
                                        #group = DV_type
                                        )) +
  geom_linerange(aes(ymin = pi_lower, ymax = pi_upper), size = 0.5, position = position_dodge(width = 0.8), linetype = "dotted") +
  geom_linerange(aes(ymin = ci_lower, ymax = ci_upper), size = 1.0, position = position_dodge(width = 0.8)) +
...
p_prop_discriminable_scoring <-
  ggplot(results_disciminability_scoring, aes(DV_type, estimate, 
                                              #color = DV_type, 
                                              #shape = DV_type, 
                                              #group = DV_type
                                              )) +
...
p_ci_width_proportion_observed_range_scoring <-
  ggplot(results_ci_width_proportions_scoring, aes(DV_type, estimate, 
                                                   #color = DV_type, 
                                                   #shape = DV_type, 
                                                   #group = DV_type
                                                   )) +
