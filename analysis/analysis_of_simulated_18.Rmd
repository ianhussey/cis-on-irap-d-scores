...
data_trial_level <- read_rds("../data/data_trial_level_simulated_18_trials.rds") %>%
...
if(file.exists("models/simulated_estimates_D_18_trials.rds")) {
  ...
  data_estimates_D <- read_rds("models/simulated_estimates_D_18_trials.rds")
  ...
  # save to disk
  write_rds(data_estimates_D, "models/simulated_estimates_D_18_trials.rds", compress = "gz")
...
# bootstrapping has a long execution time, so load saved values if they've already been calculated
if(file.exists("models/simulated_estimates_PI_18_trials.rds")) {
  
  data_estimates_PI <- read_rds("models/simulated_estimates_PI_18_trials.rds")
  ...
  # save to disk
  write_rds(data_estimates_PI, "models/simulated_estimates_PI_18_trials.rds", compress = "gz")
...
# save to disk
write_rds(results_diff_zero_method, "models/results_diff_zero_method_18_trials.rds")
