...
data_iat_processed_participant_level <- read_rds("../processed/data_iat_processed_participant_level.rds")
data_iat_raw_trial_level <- read_rds("../raw/data_iat_raw_trial_level.rds")
...
if(file.exists("data_iat_trimmed.rds")){
  ...
  data_iat_trimmed <- write_rds("data_iat_trimmed.rds")
  ...
  data_participant_level_subset <- data_iat_processed_participant_level |>
    ...
    slice_sample(n = 50) |> 
    ungroup() |>
    select(session_id, age, sex, domain, block_order, D, A)
